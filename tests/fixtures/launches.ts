...
export const UPCOMING_LAUNCHES: Launch[] = [
  {
    ...
    vehicleVisual: {
      ...
      singleUse: false,
      sourceLabel: 'LaunchWatch fixture',
    ...
    firstStage: {
      ...
      flightNumber: 7,
      reused: true,
      previousFlightName: 'Astra Nova | Meridian Pathfinder',
      previousFlightDate: '2035-06-19T10:14:00.000Z',
      turnaroundSeconds: 39 * 86_400 + 4 * 3_600 + 16 * 60,
      landingAttempt: true,
      landingSuccess: null,
...
export const HISTORICAL_LAUNCHES: Launch[] = [
  {
    ...
    missionVisual: {
      ...
      url: '/icon-512.png',
      thumbnailUrl: '/icon-512.png',
      name: 'Demo Return Flight mission',
      credit: 'LaunchWatch fixture',
      licenseName: 'CC BY 4.0',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      singleUse: false,
