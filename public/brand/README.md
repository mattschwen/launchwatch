...
do not add shadows, glows, or alternate colors. The header uses the quieter
typographic wordmark; the stable root PNG and favicon exports are derived from
these source files for platform use. Keep the standard and maskable app icons
