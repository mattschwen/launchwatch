...
- Validated provider launch windows keep the UTC range authoritative and add a
  compact duration cue plus a hydration-safe, 44-pixel inline switch between
  the viewer and launch-site start/end ranges. Equivalent ranges collapse, and
  midnight crossings name both dates instead of one day.
